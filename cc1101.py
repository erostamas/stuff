...
class cc1101(object):
    ...
    def setDefaultValues(self, version=1):
        ...
        self._writeSingleByte(self.PKTLEN, 150)
    ...
    def sendData(self, dataBytes):
        ...
        if sending_mode == "PKT_LEN_FIXED":
            ...
            if self.debug:
                ...
                print(f"Length of the packet is: {data_len}")
        ...
        while remaining_bytes != 0:
            ...
            remaining_bytes = self._readSingleByte(self.TXBYTES) & 0x7F
            if self.debug:
                print(f"Waiting until all bytes are transmited, remaining bytes: {remaining_bytes}")
